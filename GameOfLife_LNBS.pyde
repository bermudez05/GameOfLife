# Juego de la vida - Version final (Laura Nicole Bermudez Santa) (Python - processig 3)
...
# Funciones para relaizar las tareas descritas: 
...
def keyPressed(): # interaccion con el teclaod
    global pause
